  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#ffffff' }} contentContainerStyle={{ padding: 12, paddingBottom: 120 }}>
      ...
      {dataHeoThit ? (() => {
        ...
        // 🎯 ĐÃ VÁ TÁCH BIỆT: Trả ô cai sữa 3 tuần và 4 tuần về đúng mỏ neo của Server gửi về, không gộp chung gây lộn số
        khoRealTime["3 Tuần Cai Sữa"] = laySoTho(dataHeoThit["3 Tuần Cai Sữa"]) || laySoTho(dataHeoThit.caiSua3Tuan) || 0;
        khoRealTime["4 Tuần"] = laySoTho(dataHeoThit["4 Tuần"]) || laySoTho(dataHeoThit.caiSua) || 0; 

        // Khởi tạo tăm tắp quân số cho các ô tuần còn lại từ Server đổ về
        ...
        // Ép tự động cộng tổng giai đoạn
        ...
        // Tổng số lợn bao gồm cả ô cai sữa sớm biệt lập
        const tongQuânSoHThit = soHeoTheoMeGoc + khoRealTime["3 Tuần Cai Sữa"] + khoRealTime["4 Tuần"] + tGd3 + tGd4 + tGd5 + tGd6 + tGd7;
          ...
          <View style={{ width: '100%' }}>
            ...
            <View style={{ marginBottom: 12, backgroundColor: '#f8f9fa', padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#eee' }}>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Text style={{ fontSize: 16, fontWeight: '900', color: '#137333' }}> {tongQuânSoHThit} con</Text>
              </View>
              <Text style={{ fontSize: 11, color: '#6c757d', fontStyle: 'italic', marginTop: 4, fontWeight: '500' }}>
                ( Số liệu display value nạp trực tiếp từ Server Cloud )
              </Text>
            </View>
            ...
            <View style={{ backgroundColor: '#ffffff', borderRadius: 10, marginBottom: 15, borderWidth: 1, borderColor: '#dee2e6', padding: 10, gap: 10 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fdfdfd', padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#dee2e6' }}>
                <Text style={{ fontWeight: 'bold', fontSize: 14 }}>1. Giai đoạn Theo Mẹ (3 Tuần)</Text>
                <Text style={{ fontSize: 15, fontWeight: 'bold' }}>{soHeoTheoMeGoc} con</Text>
              </View>

              {/* 🎯 ĐÃ BỔ SUNG KHỐI TÁCH BIỆT: Ô cai sữa sớm 3 tuần tuổi */}
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 12, backgroundColor: '#fffdf9', borderRadius: 8, borderWidth: 1, borderColor: '#ffd3b6', alignItems: 'center' }}>
                <Text style={{ fontWeight: 'bold', fontSize: 14, color: '#e65100' }}>2. Giai đoạn Cai Sữa Sớm (3 Tuần)</Text>
                <Text style={{ fontSize: 15, fontWeight: 'bold', color: '#e65100' }}>{khoRealTime["3 Tuần Cai Sữa"]} con</Text>
              </View>

              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fdfdfd', padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#dee2e6' }}>
                <Text style={{ fontWeight: 'bold', fontSize: 14 }}>3. Giai đoạn Cai Sữa Chuẩn (4 Tuần)</Text>
              ...
              <View style={{ backgroundColor: '#fffdf9', borderRadius: 8, borderWidth: 1, borderColor: '#ffe0b2', padding: 10 }}>
                <TouchableOpacity onPress={() => setOpenGiaiDoan(prev => ({ ...prev, gd3: !prev.gd3 }))} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <View style={{ flex: 1, paddingRight: 6 }}>
                    <Text style={{ fontWeight: 'bold', color: '#e65100', fontSize: 14 }}>4. Giai đoạn: 10 - 30kg</Text>
              ...
              <View style={{ backgroundColor: '#fffdf9', borderRadius: 8, borderWidth: 1, borderColor: '#ffe0b2', padding: 10 }}>
                <TouchableOpacity onPress={() => setOpenGiaiDoan(prev => ({ ...prev, gd4: !prev.gd4 }))} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <View style={{ flex: 1, paddingRight: 6 }}>
                    <Text style={{ fontWeight: 'bold', color: '#e65100', fontSize: 14 }}>5. Giai đoạn: 30 - 60kg</Text>
              ...
              <View style={{ backgroundColor: '#fffdf9', borderRadius: 8, borderWidth: 1, borderColor: '#ffe0b2', padding: 10 }}>
                <TouchableOpacity onPress={() => setOpenGiaiDoan(prev => ({ ...prev, gd5: !prev.gd5 }))} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <View style={{ flex: 1, paddingRight: 6 }}>
                    <Text style={{ fontWeight: 'bold', color: '#e65100', fontSize: 14 }}>6. Giai đoạn: 60 - 100kg</Text>
              ...
              <View style={{ backgroundColor: '#ffffff', borderRadius: 8, borderWidth: 1, borderColor: '#f5c6cb', padding: 10 }}>
                <TouchableOpacity onPress={() => setOpenGiaiDoan(prev => ({ ...prev, gd6: !prev.gd6 }))} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <View style={{ flex: 1, paddingRight: 6 }}>
                    <Text style={{ fontWeight: 'bold', color: '#c82333', fontSize: 14 }}>7. Giai đoạn: 100kg - 130kg</Text>
              ...
              <View style={{ backgroundColor: '#ffffff', borderRadius: 8, borderWidth: 1, borderColor: '#f5c6cb', padding: 10 }}>
                <TouchableOpacity onPress={() => setOpenGiaiDoan(prev => ({ ...prev, gd7: !prev.gd7 }))} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                  <View style={{ flex: 1, paddingRight: 6 }}>
                    <Text style={{ fontWeight: 'bold', color: '#c82333', fontSize: 14 }}>8. Giai đoạn: 130kg - Xuất Chuồng</Text>
                  ...
                  const parseDateToTimestampChuan = (obj) => {
                    ...
                    try {
                      ...
                      if (chuoiNgayGoc.includes('/')) {
                        ...
                        if (phanTu.length === 3) return new Date(parseInt(phanTu[2], 10), parseInt(phanTu[1], 10) - 1, parseInt(phanTu[0], 10)).getTime() || 0;
                      } else if (chuoiNgayGoc.includes('-')) {
                        const phanTu = chuoiNgayGoc.split('-');
                        if (phanTu.length === 3) return new Date(parseInt(phanTu[0], 10), parseInt(phanTu[1], 10) - 1, parseInt(phanTu[2], 10)).getTime() || 0;
                      }
                  ...
                  return (
                    <View key={`ht_f_${item.id || idx}`} style={{ backgroundColor: '#ffffff', borderWidth: 1, borderColor: item.syncStatus === "waiting" ? '#ffb74d' : '#e9ecef', borderRadius: 10, padding: 12, marginBottom: 8 }}>
                      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                        ...
                        {/* 🎯 ĐÃ VÁ CHÍ MẠNG: Đọc trực tiếp chuỗi ngày thô từ Server gửi về, không chạy hàm new Date() gây crash giao diện */}
